...
: ${AMENT_CURRENT_PREFIX:="/home/samuel/hello_robot/src/install/hello_robot_package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hello_robot_package/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hello_robot_package/environment/path.sh"
